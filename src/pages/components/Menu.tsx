  ...
  return (
    <div className="p-3 px-5 border-b flex justify-between bg-white lg:sticky lg:-top-1 lg:z-10">
      ...
      <div className="flex items-center space-x-2 lg:space-x-4 text-xs">
        ...
        }} className="flex items-center cursor-pointer text-gray-500 hover:text-red-500 text-center lg:text-left">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="hidden md:block w-3.5 h-3.5 mr-2">
